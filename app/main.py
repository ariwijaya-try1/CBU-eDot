...
from app.api.routes.customer_salesman_mapping import router as customer_salesman_mapping_router
...
app.include_router(customer_salesman_mapping_router, prefix="/api", tags=["Mapping"])
